...
const firebaseConfig = {
    apiKey: "",
    authDomain: "dontpage.firebaseapp.com",
    databaseURL: "https://dontpage-7fc6c-default-rtdb.firebaseio.com/",
    projectId: "dontpage-7fc6c",
    storageBucket: "dontpage.appspot.com",
    messagingSenderId: "SEU_SENDER_ID",
    appId: "dontpage-7fc6c"
};

// Adicione esta função para lidar com as mudanças de URL
...
document.addEventListener('DOMContentLoaded', function () {
    // ... (mantenha todas as declarações de elementos existentes)

    // Adicione um novo botão para o menu mobile
    ...
    // Atualize a função toggleSidebar para usar o novo sistema
    ...
    // Modifique a função checkUrlForPageId para criar páginas no Firebase
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createPage(name = null, template = 'blank') {
        ...
        // Verifica se a página já existe no Firebase
        database.ref('pages/' + pageId).once('value').then((snapshot) => {
            if (snapshot.exists()) {
            ...
            // Cria a nova página no Firebase
            const newPage = {
                id: pageId,
                name: name || pageId,
            ...
            database.ref('pages/' + pageId).set(newPage);
            
            // Adiciona à lista local de páginas
            pages.push(newPage);
            savePages();
    ...
    function getTemplateContent(template) {
        switch (template) {
            ...
            case 'blog': return '# Blog Post Title\n\n## Introduction\n\nStart writing...\n\n## Main Content\n\nAdd your content.\n\n## Conclusion\n\nWrap up.';
            case 'code': return '```javascript\n// Write your code here\nfunction hello() {\n  console.log("Hello World!");\n}\n```';
            default: return '';
        }
    }

    // Atualize o evento fetch no service worker
